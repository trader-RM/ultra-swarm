...
export const AGENT_TOOL_MAP: Record<AgentName, ToolName[]> = {
	...
	conversation_analyzer: ['knowledge_recall'],
	pr_test_analyzer: [
		'diff',
		'imports',
		'lint',
	...
	// ECC Analysis agent — no swarm tools needed; native OpenCode tools (Read, Grep, Glob, Bash)
	// pass through automatically via AgentConfig.permission and are unaffected by this empty list.
	type_design_analyzer: [],
};
...
export const DEFAULT_MODELS: Record<string, string> = {
	...
	// New ECC agents
	code_architect: 'opencode/trinity-large-preview-free',
	code_simplifier: 'opencode/minimax-m2.5-free',
	code_explorer: 'opencode/trinity-large-preview-free',
	comment_analyzer: 'opencode/trinity-large-preview-free',
