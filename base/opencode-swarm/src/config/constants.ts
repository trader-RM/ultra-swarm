...
export const AGENT_TOOL_MAP: Record<AgentName, ToolName[]> = {
	...
	// ECC Review/QA agents — mirror Swarm reviewer toolset
	code_reviewer: [
		'diff',
		'imports',
		'lint',
	...
	// ECC Build agents — mirror Swarm coder toolset
	build_error_resolver: [
		'diff',
		'imports',
		'lint',
	...
	// ECC Pipeline agents — coder+test_engineer merge
	tdd_guide: [
		'diff',
		'imports',
		'lint',
	...
	// ECC Support agents — mirror Swarm sme/docs merge
	planner: [
		'complexity_hotspots',
		'detect_domains',
		'extract_code_blocks',
